...
// Creating array of Pizza
const favPizza:string[] = ["cheez pizza", "meat pizza", "italian pizza"];

console.log("Pizza names :");

// Using for of loop to print each pizza :
...
// Usint another loop to print pizza name with statements
for(const pizza of favPizza)
{
    console.log(`I like ${pizza}.`);
}

// State about the All Pizzas
