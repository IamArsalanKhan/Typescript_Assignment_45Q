...
const current_users: any = ["Arsalan", "Umair", "LuQman", "Ahmad", "Jamal", "Ronaldo"];

const new_users: any = ["Luqman", "Umair", "Sadam", "Jawad", "Nouman", "Messi"];

let current_users_Lower: any = current_users.map(user => user.toLowerCase());
